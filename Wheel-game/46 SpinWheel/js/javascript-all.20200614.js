        ...
        X && f.push(jb[0]),
          ...
          b
            ...
            .bind("keydown.jsp", function (b) {
              if (
                b.target === this ||
                (f.length && a(b.target).closest(f).length)
              ) {
                var g = bb,
                  h = $;
                switch (b.keyCode) {
          ...
          N.hideFocus
            ? (b.css("outline", "none"),
              "hideFocus" in R[0] && b.attr("hideFocus", !0))
            : (b.css("outline", ""),
...
// main js
function wheelToWeek() {
  "use strict";

  $(".clacker").addClass("act");
  $(".wheel").addClass("act");
  $(".wheel").addClass("week1");
  $(".box-head-games-img1, .box-head-games-img2").addClass("games-wk1");
  setTimeout(function () {
    $(".clacker").removeClass("act");
    $(".clacker").addClass("act-slow");
  }, 5000);
  setTimeout(function () {
    $(".wk1").addClass("act");
    $(".wheel-top h2.act").fadeIn(500);
    $(".slice").removeClass("act");
    $(".slice1").addClass("act");
    $(".clacker").removeClass("act-slow");
  }, 6000);

  setTimeout(function () {
    $(".overlay, .lbox-games").fadeIn(200);
  }, 7000);
  $(".wheel-wrap").css("pointer-events", "none");
  setTimeout(function () {
    $(".wheel-wrap").css("pointer-events", "auto");
  }, 6000);
}
...
$(document).ready(function () {
  ...
  $(".wheel-top").css("pointer-events", "none");
  $(".btn1").on("click", function () {
    $(".lbox").hide();
    scrollmax();
    $(".overlay, .lbox-fdb").fadeIn(200);
    $(".nav-tab1").trigger("click");
    setTimeout(function () {
      $(".box-head > img").addClass("act");
    }, 500);
  });
  $(".btn2").on("click", function () {
    $(".lbox").hide();
    scrollmax();
    $(".overlay, .lbox-gadgets").fadeIn(200);
    $(".nav-tab1").trigger("click");
    setTimeout(function () {
      $(".box-head > img").addClass("act");
    }, 500);
  ...
  $(".btn-ylw2").on("click", function () {
    $(".lbox").hide();
    scrollmax();
    $(".overlay, .lbox-terms").fadeIn(200);
  });
  $("body").on("click", "#tpl-question-btn-mobi", function (e) {
    e.preventDefault();
    $(".lbox").hide();
    $(".overlay, .lbox-terms").fadeIn(200);
  });
  $(".slice, .wheel-top, .btn, .btn-ylw ").on("click", function () {
    $("body").css("overflow", "hidden");
  });
  $(".overlay, .close").click(function () {
    $("body").css("overflow", "auto");
    $(".overlay, .lbox").fadeOut(200);
    $(".box-head > img, .box-head > span").removeClass("act");
  });

  function scrollmax() {
    setTimeout(function () {
      var lboxH = $(".lbox").height();
      $(".lbox").css("height", "100%");
      $(".lbox-games .scroll-pane, .lbox-terms .scroll-pane").css(
        "height",
        lboxH - 40 + "px"
      );
      $(".lbox-fdb .scroll-pane, .lbox-gadgets .scroll-pane").css(
        "height",
        lboxH - 100 + "px"
      );
  ...
  $(".nav-tab").on("click", function () {
    $(".nav-tab").removeClass("act");
  });
  $(".nav-tab1").on("click", function () {
    $(".nav-tab1").addClass("act");
    $(".tab-content").removeClass("act");
    $(".tab-content1").addClass("act");
  });
  $(".nav-tab2").on("click", function () {
    $(".nav-tab2").addClass("act");
    $(".tab-content").removeClass("act");
    $(".tab-content2").addClass("act");
  });
  if ($("body").hasClass("client") && $("body").hasClass("scgold")) {
    $(".accord h3").append(
      '<span class="accord-arw"><img src="../../../_img/tc-arw.png">'
    );
  } else if ($("body").hasClass("native") && $("body").hasClass("scgold")) {
    $(".accord h3").append(
      '<span class="accord-arw"><img src="../../../_img/tc-arw.png">'
    );
  } else if (
    $("body").hasClass("scgold") ||
    $("body").hasClass("client") ||
    $("body").hasClass("native")
  ) {
    $(".accord h3").append(
      '<span class="accord-arw"><img src="../../_img/tc-arw.png">'
    );
  ...
  $(".accord, .accord a").click(function (e) {
    e.stopPropagation();
  });
  ...
  function optinflash() {
    ...
    $(".optin").click(function (event) {
      ...
      playPop(this, tabsMe, 400, 300);
    });
  }

  function playPop(mylink, tabsMe, width, height) {
    ...
    window.open(
      href,
      tabsMe,
      "width=" + myWidth + ",height=" + myHeight + ",scrollbars=yes"
    );
    return !1;
  }
  optinflash();
...
$(window).on("load", function () {
  "use strict";
  setTimeout(function () {
    if (window.location.hash == "#gadgets-galore") {
      $(".overlay, .lbox").hide();
      $(".btn2").trigger("click");
    }
  }, 7000);
  $(".tpl-lang-trigger, .tpl-lang-wrap, .tpl-lang a").on(
    "mouseover",
    function (e) {
      e.stopPropagation();
      $(".tpl-lang-select").slideDown().finish();
      $(".tpl-arw-lang").addClass("up");
    }
  );
  $(".tpl-lang-trigger, .tpl-lang-wrap, .tpl-lang a").on(
    "mouseout",
    function (e) {
      e.stopPropagation();
      $(".tpl-lang-select").slideUp().finish();
      $(".tpl-arw-lang").removeClass("up");
    }
  );
  $(function () {
