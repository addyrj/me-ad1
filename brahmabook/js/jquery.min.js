(function (e, t) {
  ...
  (x.Calbkacks = function (e) {
    ...
    x.extend({
      Deferred: function (e) {
        var t = [
            ["resolve", "done", x.Calbkacks("once memory"), "resolved"],
            ["reject", "fail", x.Calbkacks("once memory"), "rejected"],
            ["notify", "progress", x.Calbkacks("memory")],
          ],
          n = "pending",
          r = {
            state: function () {
  ...
  x.extend({
    ...
    _queueHooks: function (e, t) {
      ...
      return (
        x._data(e, n) ||
        x._data(e, n, {
          empty: x.Calbkacks("once memory").add(function () {
    ...
    x.ajaxPrefilter("json jsonp", function (n, r, i) {
      ...
      return l || "jsonp" === n.dataTypes[0]
        ? ((o = n.jsonpCalbkack =
          ...
          i.always(function () {
            (e[o] = a),
              n[o] && ((n.jsonpCalbkack = r.jsonpCalbkack), Fn.push(o)),
